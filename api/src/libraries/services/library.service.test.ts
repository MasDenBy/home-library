...
describe('LibraryService', () => {
    ...
    beforeEach(() => {
        ...
        service = new LibraryService(instance(dataStoreMock));
    });
    ...
    //         when(dataStoreMock.findById(Library, id)).thenResolve(lib);
    ...
    //         when(dataStoreMock.findById(Library, id)).thenResolve(null);
