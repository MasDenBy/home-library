...
import { Connection, DeleteQueryBuilder, DeleteResult, Repository, SelectQueryBuilder } from 'typeorm';
...
describe('BaseDataStore', () => {
    ...
    test('delete', async () => {
        ...
        when(deleteQueryBuilder.from(TestEntity)).thenReturn(instance(deleteQueryBuilder));
