...
describe('BookDataStore', () => {
    ...
    beforeEach(() => {
        ...
        when(connectionMock.getRepository(Book)).thenReturn(instance(bookRepositoryMock));
    ...
    test('deleteById', async () => {
        ...
        when(connectionMock.createQueryBuilder()).thenReturn(instance(selectQueryBuilder));
